...
public class Authority {
    ...
    public static final String[] DOCTOR_AUTHORITIES = { "user:read", "user:create", "user:delete" };
    public static final String[] ASSISTANT_AUTHORITIES = { "user:read", "user:create", "user:update" };
}
